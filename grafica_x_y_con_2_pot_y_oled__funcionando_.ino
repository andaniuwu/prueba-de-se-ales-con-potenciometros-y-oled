...
int x[28]; //buffer de la grafica 
int y[28]; //buffer secundario de la grafica 

int w[28]; //buffer de la grafica 
int z[28]; //buffer secundario de la grafica 
...
void loop(){
  ...
  x[27]=graficaVoltaje; //asigna el valor escalado a el ultimo dato de la matriz
  ...
  y[27]=graficaVoltajee; //asigna el valor escalado a el ultimo dato de la matriz
